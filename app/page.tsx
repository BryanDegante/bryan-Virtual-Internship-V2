					...
					<div className="row">
						<div className={styles.landing__wrapper}>
							<div className={styles.landing__content}>
								...
								<div
									className={
										styles.landing__content__subtitle
									}
								>
					...
					<div className="row">
						...
						<div className={styles.statistics__wrapper}>
							...
							>
								...
								<div
									className={
										styles['statistics__heading--active']
									}
								>
							...
							>
								<div className={styles.statistics__data}>
									<div
										className={
											styles['statistics__data--number']
										}
									>
										93%
									</div>
						...
						<div className={styles.reviews__wrapper}>
							<div className={styles.review}>
								...
								<div className={styles.review__body}>
									...
									me! It&apos;s saved me so much time and
									effort in reading and comprehending books.
							...
							<div className={styles.review}>
								...
								<div className={styles.review__body}>
									...
									It&apos;s also very user-friendly and
									intuitive.
								</div>
							</div>
							...
							<div className={styles.review}>
								...
								<div className={styles.review__body}>
									...
									<b>
										loves reading but doesn&apos;t have the
										time
									</b>{' '}
